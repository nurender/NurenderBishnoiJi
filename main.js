...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, ar, http) {
        this.router = router;
        this.ar = ar;
        this.http = http;
    }
    LoginComponent.prototype.MyFun = function (form) {
        var _this = this;
...
module.exports = __webpack_require__(/*! E:\Nurender Bishnoi Project\OneProject\src\main.ts */"./src/main.ts");
